...
-- Orders where customer city and salesman city are different
...
-- Customers with salesmen having commission between 0.12 and 0.14
SELECT Customer.cust_name AS "Customer",
...
-- Calculating commission earned on orders
SELECT Orders.ord_no,
       Customer.cust_name,
